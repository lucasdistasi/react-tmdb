...
export const ShowInfoComponent = () => {
  ...
  return (
    loading ?
      <SpinnerComponent color={"#EA01FFFF"}/> :
      _error ? <ErrorComponent/> : info ?
        <div>
          <div
          ...
          <div className="container mx-auto bg-gray-50">
            ...
            {
              info.seasons &&
              <SeasonAccordionComponent seasons={info.seasons} showId={info.id} originalPoster={info.backdrop_path}/>
            }
        ...
        </div> : <SpinnerComponent color={"#EA01FFFF"}/>
  )
}
